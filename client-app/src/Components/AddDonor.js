        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input
                    ...
                    value={donorData.donor_address_line1}
                    onChange={handleChange}
                />
                ...
                <input
                    ...
                    value={donorData.donor_address_line2}
                    onChange={handleChange}
                />
                ...
                <button
                    type="button"
                    onClick={() =>
                        setDonorData({ ...donorData, email_opt_in: 'Yes' })
                    }
                >
                    Refresh
                </button>
